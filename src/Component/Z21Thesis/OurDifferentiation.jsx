          ...
          <div className="md:relative flex flex-col mt-0 md:mt-4">
            <div className="md:w-1/2 text-gray-600 pl-8 flex flex-col gap-14 md:gap-32 -mt-72">
              <div className="">
                ...
                />
                <h1 className="text-2xl md:text-4xl text-black font-semibold font-arimo">
                  Z21 Community
                </h1>
              ...
              <div className="">
                ...
                <p className="text-base md:text-xl md:w-3/4 border-l-2 border-[#DE5126] pl-4 md:text-left md:mt-8 mt-4 font-arimo">
