    ...
    <section
      ...
      <div className="container relative">
          ...
          <motion.ul className="md:flex md:justify-between w-2/3">
            {
              footerList.map((item, index) => {
                return (
                  <Link to={item.link}>
                    <motion.li className="border-l-2 border-[#DE5126] pl-4 text-base md:text-xl font-arimo font-semibold mb-3"
        ...
        <div className=" absolute right-0 bottom-20 md:bottom-1/3 px-10 md:px-20">
          <motion.p className="text-base md:text-xl font-arimo font-semibold"
            initial="hidden"
            whileInView="visible"
