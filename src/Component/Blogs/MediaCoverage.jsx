...
export default function MediaCoverage() {
    return (
        <>
            <section className="w-screen py-16 md:py-40 px-5 md:px-20 bg-black ">
                    ...
                    <div className="flex">
                        <div className="flex flex-col md:flex-row w-full">
                            ...
                            <div className="w-full lg:w-3/5 md:pl-16">
                                ...
                                <h1 className=" text-white mt-4 text-2xl lg:text-7xl font-semibold font-arimo">
                                    Early-stage VC Z21 Ventures planning $40 million second fund
                                </h1>
                                <div className="flex mt-8 lg:mt-12">
                                    <Link
                                        to={"https://economictimes.indiatimes.com/tech/funding/early-stage-vc-z21-ventures-planning-40-million-second-fund/articleshow/111064968.cms"}
                                        target="framename"
