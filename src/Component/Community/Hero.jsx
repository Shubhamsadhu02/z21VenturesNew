    ...
    <section className=" w-screen bg-black py-12 md:py-24 px-10 md:px-20 pt-24 md:pt-48">
      <div className="container">
        ...
        <div className="flex flex-col lg:flex-row justify-between mt-12">
          ...
          <motion.div
            className="lg:w-1/2 lg:ml-12 flex items-center justify-center"
            initial="hidden"
            whileInView="visible"
            variants={{ ...textVariants }}>
            <ul className="ml-5 mt-10 text-white space-y-6 text-base lg:text-2xl font-normal font-arimo leading-9 md:w-4/5 list-none">
              <li className="flex items-start justify-center">
                ...
                <p>
                  We host quarterly meetings with LPs and founders in the Bay
                  Area and India
                </p>
              </li>
              <li className="flex items-start justify-center">
                ...
                <p>
                  LPs are deeply involved in connecting us to prospective
                  startups and reviewing
                </p>
              </li>
              <li className="flex items-start justify-center">
                <img src={list3} alt="" className="w-12 h-12 mr-6" />
                <p>
                  LPs support and guide founders on several areas including
                  getting the right PMF, team building and operations and
                  setting up a robust GTM engine
                </p>
              </li>
              <li className="flex items-start justify-center">
