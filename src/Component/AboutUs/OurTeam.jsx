    ...
    return (
        <section className="w-screen py-12 md:py-24 px-10 md:px-20 bg-no-repeat bg-cover bg-center" style={{ backgroundImage: `url(${TeamBg})` }}>
            <div className="container">
                <motion.h1 className="text-black text-4xl md:text-8xl font-semibold mb-16 font-arimo"
                    initial="hidden"
                    whileInView="visible"
                        ...
                        ourTeam.map((item, index) => {
                            return (
                                <div key={index} className="group p-8 transition duration-300 ease-in-out hover:shadow-lg hover:p-5 rounded-md hover:scale-105">
                                    <img src={item.image} alt="" className='grayscale group-hover:grayscale-0 w-96' />
