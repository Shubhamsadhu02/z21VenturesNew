  ...
  return (
    <div
      ...
      <div className="container">
        ...
        <div className="">
          <motion.p className="text-base md:text-lg lg:text-xl w-1/2 md:w-1/3 text-white font-normal font-arimo absolute bottom-48 md:bottom-56 right-0 md:right-28"
            initial="hidden"
            whileInView="visible"
            variants={{ ...textVariants }}>
