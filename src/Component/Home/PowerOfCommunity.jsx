      ...
      <div className="container">
        <div className="w-full ">
          <div className=" text-gray-600">
            <h2
              className="text-lg font-semibold uppercase tracking-wider text-left text-orange-500 mb-4 font-kalnia">
              Community
            </h2>
            <div className="pb-4">
              <h1
                className="text-black text-7xl font-semibold mt-4 text-left font-arimo"
          ...
          <div className="flex justify-between mt-24">
            ...
            <div className=" w-2/5">
              <p className="text-xl font-normal border-l-2 border-orange-500 pl-4 md:text-left mt-4 md:mt-8 font-arimo">
              ...
              <Link to={""} className=" text-lg font-semibold mt-4 flex font-arimo">
